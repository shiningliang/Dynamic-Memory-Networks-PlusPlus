    ...
    for run in range(10):
        for task_id in range(1, 21):
            ...
            for epoch in range(256):
                dset.set_mode('train')
                train_loader = DataLoader(dset, batch_size=128, shuffle=True, collate_fn=pad_collate)
                ...
                if not early_stopping_flag:
                    ...
                    dset.set_mode('valid')
                    valid_loader = DataLoader(dset, batch_size=128, shuffle=False, collate_fn=pad_collate)
            ...
            dset.set_mode('test')
            test_loader = DataLoader(dset, batch_size=128, shuffle=False, collate_fn=pad_collate)
            test_acc = 0
            cnt = 0
